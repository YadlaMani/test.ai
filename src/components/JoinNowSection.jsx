...
export function JoinNowSection() {
  return (
    <div
      className="h-[25rem] w-full rounded-md relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        <h1
          className="text-3xl md:text-5xl font-bold bg-clip-text  text-center text-transparent
          bg-gradient-to-b from-neutral-900 to-neutral-600 dark:from-neutral-50 dark:to-neutral-400 bg-opacity-50">
          Join Test.ai
        </h1>
        <p
          className="mt-4 font-normal text-2xl text-center text-neutral-700 dark:text-neutral-400">
